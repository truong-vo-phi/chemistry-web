...
export const metadata: Metadata = {
  title: 'Student Dashboard | ChemLab 3D',
  description: 'Bảng điều khiển trung tâm cho học viên với lộ trình, nhiệm vụ và hoạt động.',
};
    ...
    <div className="min-h-screen bg-background text-on-surface">
      ...
      <main className="mx-auto w-full max-w-container-max px-margin-mobile py-8 md:px-margin-desktop">
        <section className="rounded-xl border-2 border-primary-fixed-dim bg-surface-container-lowest p-6 shadow-sm">
          ...
          <h1 className="font-display-lg-mobile text-display-lg-mobile text-primary md:font-headline-md md:text-headline-md">Student Dashboard</h1>
          <p className="mt-3 max-w-3xl text-on-surface-variant">Bảng điều khiển trung tâm cho học viên với lộ trình, nhiệm vụ và hoạt động.</p>
          <p className="mt-2 text-xs text-outline">Route: {appRoutes.studentDashboard}</p>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link href={appRoutes.profileAchievements} className="rounded-full border-2 border-outline-variant bg-surface px-5 py-2 font-label-sm text-on-surface hover:bg-surface-container">
              Xem thành tích
            </Link>
          </div>
        </section>
