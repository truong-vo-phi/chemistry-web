...
export const metadata: Metadata = {
  title: 'Kết Quả Thí Nghiệm | ChemLab 3D',
  description: 'Theo dõi hiệu suất thực hành, điểm tiến bộ và phân tích theo mô-đun.',
};
    ...
    <div className="min-h-screen bg-background text-on-surface">
      ...
      <main className="mx-auto w-full max-w-container-max px-margin-mobile py-8 md:px-margin-desktop">
        <section className="rounded-xl border-2 border-primary-fixed-dim bg-surface-container-lowest p-6 shadow-sm">
          ...
          <h1 className="font-display-lg-mobile text-display-lg-mobile text-primary md:font-headline-md md:text-headline-md">Kết Quả Thí Nghiệm</h1>
          <p className="mt-3 max-w-3xl text-on-surface-variant">Theo dõi hiệu suất thực hành, điểm tiến bộ và phân tích theo mô-đun.</p>
          <p className="mt-2 text-xs text-outline">Route: {appRoutes.experimentResults}</p>
