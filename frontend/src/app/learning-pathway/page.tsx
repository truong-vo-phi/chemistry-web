...
export const metadata: Metadata = {
  title: 'Lộ Trình Học Tập | ChemLab 3D',
  description: 'Theo dõi hành trình học và mở khóa nội dung theo tiến độ.',
};
    ...
    <div className="min-h-screen bg-background text-on-surface">
      ...
      <main className="mx-auto w-full max-w-container-max px-margin-mobile py-8 md:px-margin-desktop">
        <section className="rounded-xl border-2 border-primary-fixed-dim bg-surface-container-lowest p-6 shadow-sm">
          ...
          <h1 className="font-display-lg-mobile text-display-lg-mobile text-primary md:font-headline-md md:text-headline-md">Lộ Trình Học Tập</h1>
          <p className="mt-3 max-w-3xl text-on-surface-variant">Theo dõi hành trình học và mở khóa nội dung theo tiến độ.</p>
          <p className="mt-2 text-xs text-outline">Route: {appRoutes.learningPathway}</p>
