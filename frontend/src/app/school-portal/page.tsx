...
export const metadata: Metadata = {
  title: 'School Portal | ChemLab 3D',
  description: 'Trang điều hành cấp trường: giám sát lớp, nội dung, người dùng và KPI.',
};
    ...
    <div className="min-h-screen bg-background text-on-surface">
      ...
      <main className="mx-auto w-full max-w-container-max px-margin-mobile py-8 md:px-margin-desktop">
        <section className="rounded-xl border-2 border-primary-fixed-dim bg-surface-container-lowest p-6 shadow-sm">
          ...
          <h1 className="font-display-lg-mobile text-display-lg-mobile text-primary md:font-headline-md md:text-headline-md">School Portal</h1>
          <p className="mt-3 max-w-3xl text-on-surface-variant">Trang điều hành cấp trường: giám sát lớp, nội dung, người dùng và KPI.</p>
          <p className="mt-2 text-xs text-outline">Route: {appRoutes.schoolPortal}</p>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link href={appRoutes.courseManagementCategories} className="rounded-full border-2 border-outline-variant bg-surface px-5 py-2 font-label-sm text-on-surface hover:bg-surface-container">
              Quản lý danh mục
            </Link>
