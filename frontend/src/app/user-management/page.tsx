...
export const metadata: Metadata = {
  title: 'Quản Lý Người Dùng | ChemLab 3D',
  description: 'Quản trị tài khoản, vai trò và quyền truy cập trong toàn hệ thống.',
};
    ...
    <div className="min-h-screen bg-background text-on-surface">
      ...
      <main className="mx-auto w-full max-w-container-max px-margin-mobile py-8 md:px-margin-desktop">
        <section className="rounded-xl border-2 border-primary-fixed-dim bg-surface-container-lowest p-6 shadow-sm">
          ...
          <h1 className="font-display-lg-mobile text-display-lg-mobile text-primary md:font-headline-md md:text-headline-md">Quản Lý Người Dùng</h1>
          <p className="mt-3 max-w-3xl text-on-surface-variant">Quản trị tài khoản, vai trò và quyền truy cập trong toàn hệ thống.</p>
          <p className="mt-2 text-xs text-outline">Route: {appRoutes.userManagement}</p>
