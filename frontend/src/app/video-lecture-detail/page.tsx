...
export const metadata: Metadata = {
  title: 'Chi Tiết Video Bài Giảng | ChemLab 3D',
  description: 'Trang học qua video, tài liệu đi kèm và điều hướng bài liên quan.',
};
    ...
    <div className="min-h-screen bg-background text-on-surface">
      ...
      <main className="mx-auto w-full max-w-container-max px-margin-mobile py-8 md:px-margin-desktop">
        <section className="rounded-xl border-2 border-primary-fixed-dim bg-surface-container-lowest p-6 shadow-sm">
          ...
          <h1 className="font-display-lg-mobile text-display-lg-mobile text-primary md:font-headline-md md:text-headline-md">Chi Tiết Video Bài Giảng</h1>
          <p className="mt-3 max-w-3xl text-on-surface-variant">Trang học qua video, tài liệu đi kèm và điều hướng bài liên quan.</p>
          <p className="mt-2 text-xs text-outline">Route: {appRoutes.videoLectureDetail}</p>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link href={appRoutes.quizReview} className="rounded-full border-2 border-outline-variant bg-surface px-5 py-2 font-label-sm text-on-surface hover:bg-surface-container">
              Đánh giá quiz
            </Link>
